...
const Dashboard = () => {
    ...
    const fetchProducts = async () => {
        ...
        try {
            ...
            alert("Could not connect to backend. Make sure the backend server is running.");
            console.log('Error::Dashboard::fetchProducts', error)
        } finally {
    ...
    }, [isLogin, products, isFetchFinished])
